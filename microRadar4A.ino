// Microwave radar RCWL 0516; measure duty cycle, send over USB serial port; CR-LF added   
...
void action() {
  ...
  if(radartotalcount==0)
      Serial.println("[E001]"); //divide by zero; if tick() has just set them to zero
  else
  if (pirtotalcount1==0)
      Serial.println("[E002]"); 
  else{
